...
model.train(data="C:\\Users\\jakob.derzapf\\source\\repos\\PythonProjekte\\YOLO\\UI-Control-C#-7\\config\\data.yaml", 
            ...
            lr0=0.001,               # Reduzierte Start-Lernrate für stabilere Konvergenz
